...
const Footer = () => {
	return (
		<div className="w-full bg-[#7CB342] mt-32">
			<div className="max-w-[1240px] mx-auto px-3 text-black">
				<section className="grid md:grid-cols-3 gap-8 mb-10 px-6">
					<div className="mt-5">
						<div className="flex items-center gap-2">
							<img className="w-20 h-20" src={logo} alt="" />
							<h1 className="text-3xl font-semibold mb-2">
								Find<span className="text-[#05b6d1]">College</span>
							</h1>
						</div>
					...
					<div className="mt-5">
						...
						<div className="md:w-full">
							<input
								className="p-3 rounded border-bg-[#05b6d1] border"
								type="email"
								name="email"
								placeholder="Email"
							/>
							<button className="bg-[#05b6d1] ml-2 p-3 rounded text-white">
								Submit
							</button>
						</div>
					</div>
				...
				<div className="text-center mt-10">
					...
					<h1 className="p-6">
						&copy;copyright 2023 All rights reserved by Amari
						<span className="text-[#05b6d1] font-extrabold">College</span>
					</h1>
				</div>
			</div>
		</div>
